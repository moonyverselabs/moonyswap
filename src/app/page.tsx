            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                <input
                  ...
                  className="w-64 px-3 py-2 bg-[#141418] border border-[#2a2a30] rounded-lg text-white text-sm placeholder-[#a0a0a8] focus:outline-none focus:border-[#D8C5FD] transition-colors"
                />
              ...
              <button
                onClick={refresh}
                disabled={loading}
                className="px-3 py-2 bg-[#1a1a1f] hover:bg-[#2a2a30] text-[#a0a0a8] rounded-lg text-sm transition-colors disabled:opacity-50"
              >
                {loading ? '...' : '↻'}
              </button>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex items-center gap-4">
                <Link
                  href="/apps"
                  className="px-4 py-2 bg-[#1a1a1f] hover:bg-[#2a2a30] text-white font-medium rounded-lg transition-colors"
                >
                  Explore Apps
                </Link>
                <span className="text-[#a0a0a8] text-sm">Spend currencies across the ecosystem</span>
              </div>
            </div>

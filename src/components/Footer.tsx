      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-10">
          ...
          <div className="flex items-center gap-4">
            <a href="https://x.com/moonyversal" target="_blank" rel="noopener noreferrer" className="text-[#a0a0a8] hover:text-white transition-colors inline-flex items-center gap-2 text-sm">
